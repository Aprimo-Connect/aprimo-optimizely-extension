define(["dojo", "epi/dependency", "epi/shell/TypeDescriptorManager"], function (
    ...
    return dojo.declare("aprimointegration.AprimoImageDataConverter", null, {
        _store: null,

        sourceDataType: "aprimointegration.contenttypes.aprimoimagedata",
        targetDataType: "aprimointegration.contenttypes.aprimoimagedata.link",
